...
export async function createNextExerciseForSession(input) {
    ...
    if (session.finishedAt) {
        ...
        return { kind: "DONE", exercise: null };
    }
    ...
    const gen = await generateExercise({
        userId: input.userId,
        listId: session.listId,
        vocabId,
        exerciseType: session.exerciseType,
        direction: normalizeDirection(session.direction),
        enabledExerciseTypes: session.enabledExerciseTypes,
