...
// @ts-nocheck 
/*
 * This file exports the `StudyAttempt` model and its related types.
 *
...
export type GetStudyAttemptAggregateType<T extends StudyAttemptAggregateArgs> = {
      [P in keyof T & keyof AggregateStudyAttempt]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateStudyAttempt[P]>
    : Prisma.GetScalarType<T[P], AggregateStudyAttempt[P]>
}
...
export type GetStudyAttemptGroupByPayload<T extends StudyAttemptGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<StudyAttemptGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof StudyAttemptGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], StudyAttemptGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], StudyAttemptGroupByOutputType[P]>
      }
    >
  >
...
export type StudyAttemptCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<StudyAttemptFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface StudyAttemptDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['StudyAttempt'], meta: { name: 'StudyAttempt' } }
  /**
   ...
   * })
  **/
  count<T extends StudyAttemptCountArgs>(
    args?: Prisma.Subset<T, StudyAttemptCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], StudyAttemptCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends StudyAttemptGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, StudyAttemptGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetStudyAttemptGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
