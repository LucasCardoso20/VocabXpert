...
// @ts-nocheck 
/*
 * This file exports the `VocabList` model and its related types.
 *
...
export type GetVocabListAggregateType<T extends VocabListAggregateArgs> = {
      [P in keyof T & keyof AggregateVocabList]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateVocabList[P]>
    : Prisma.GetScalarType<T[P], AggregateVocabList[P]>
}
...
export type GetVocabListGroupByPayload<T extends VocabListGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<VocabListGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof VocabListGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], VocabListGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], VocabListGroupByOutputType[P]>
      }
    >
  >
...
export type VocabListCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<VocabListFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface VocabListDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['VocabList'], meta: { name: 'VocabList' } }
  /**
   ...
   * })
  **/
  count<T extends VocabListCountArgs>(
    args?: Prisma.Subset<T, VocabListCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], VocabListCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends VocabListGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, VocabListGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetVocabListGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
