...
// @ts-nocheck 
/*
 * This file exports the `VocabExample` model and its related types.
 *
...
export type GetVocabExampleAggregateType<T extends VocabExampleAggregateArgs> = {
      [P in keyof T & keyof AggregateVocabExample]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateVocabExample[P]>
    : Prisma.GetScalarType<T[P], AggregateVocabExample[P]>
}
...
export type GetVocabExampleGroupByPayload<T extends VocabExampleGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<VocabExampleGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof VocabExampleGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], VocabExampleGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], VocabExampleGroupByOutputType[P]>
      }
    >
  >
...
export type VocabExampleCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<VocabExampleFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface VocabExampleDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['VocabExample'], meta: { name: 'VocabExample' } }
  /**
   ...
   * })
  **/
  count<T extends VocabExampleCountArgs>(
    args?: Prisma.Subset<T, VocabExampleCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], VocabExampleCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends VocabExampleGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, VocabExampleGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetVocabExampleGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
